...
<body class="h-full flex flex-col text-slate-800 dark:text-slate-100 bg-slate-50 dark:bg-slate-950 antialiased selection:bg-emerald-500 selection:text-white transition-colors duration-200">
    ...
    <!-- Flash Alerts -->
    @if(session('success'))
        <div class="bg-emerald-50 dark:bg-emerald-950/60 border-b border-emerald-200 dark:border-emerald-800 text-emerald-800 dark:text-emerald-200 px-4 py-3 text-sm flex items-center justify-between max-w-7xl mx-auto w-full my-2 rounded-xl">
    ...
    @if(session('warning'))
        <div class="bg-amber-50 dark:bg-amber-950/60 border-b border-amber-200 dark:border-amber-800 text-amber-800 dark:text-amber-200 px-4 py-3 text-sm flex items-center justify-between max-w-7xl mx-auto w-full my-2 rounded-xl">
            <div class="flex items-center gap-2">
    ...
    @if(session('info'))
        <div class="bg-sky-50 dark:bg-sky-950/60 border-b border-sky-200 dark:border-sky-800 text-sky-800 dark:text-sky-200 px-4 py-3 text-sm flex items-center justify-between max-w-7xl mx-auto w-full my-2 rounded-xl">
            <div class="flex items-center gap-2">
                <svg class="w-5 h-5 text-sky-600 dark:text-sky-400 shrink-0" fill="currentColor" viewBox="0 0 20 20">
    ...
    @if($errors->any())
        <div class="bg-rose-50 dark:bg-rose-950/60 border border-rose-200 dark:border-rose-800 text-rose-800 dark:text-rose-200 px-4 py-3 text-sm max-w-7xl mx-auto w-full my-2 rounded-xl">
