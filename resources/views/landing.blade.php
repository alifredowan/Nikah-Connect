...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-xs hover:shadow-md transition">
                    <div class="w-12 h-12 rounded-xl bg-emerald-100 text-emerald-800 flex items-center justify-center text-2xl mb-5">
                        🛡️
                    </div>
                    <h3 class="text-lg font-bold text-slate-900 mb-2">Wali (Guardian) Model</h3>
                ...
                <!-- Pillar 2 -->
                <div class="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-xs hover:shadow-md transition">
                    <div class="w-12 h-12 rounded-xl bg-amber-100 text-amber-800 flex items-center justify-center text-2xl mb-5">
                        🔒
                    </div>
                    <h3 class="text-lg font-bold text-slate-900 mb-2">Photo Privacy by Default</h3>
                    <p class="text-sm text-slate-600 leading-relaxed">
                ...
                <!-- Pillar 3 -->
                <div class="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-xs hover:shadow-md transition">
                    <div class="w-12 h-12 rounded-xl bg-blue-100 text-blue-800 flex items-center justify-center text-2xl mb-5">
                        ⚖️
                    </div>
                    <h3 class="text-lg font-bold text-slate-900 mb-2">Deen-Weighted Algorithm</h3>
                    <p class="text-sm text-slate-600 leading-relaxed">
                ...
                <!-- Pillar 4 -->
                <div class="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-xs hover:shadow-md transition">
                    <div class="w-12 h-12 rounded-xl bg-purple-100 text-purple-800 flex items-center justify-center text-2xl mb-5">
                        💬
                    </div>
                    <h3 class="text-lg font-bold text-slate-900 mb-2">Chaperoned Halal Chat</h3>
                    <p class="text-sm text-slate-600 leading-relaxed">
    ...
    <div class="py-20 bg-slate-50 border-t border-slate-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                <span class="text-xs font-bold uppercase tracking-wider text-amber-700">Fair & Transparent Membership</span>
                <h2 class="text-3xl font-extrabold text-slate-900 tracking-tight sm:text-4xl mt-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <!-- Free Tier -->
                <div class="bg-white rounded-2xl p-8 border border-slate-200 shadow-xs flex flex-col justify-between">
                    <div>
                        <span class="px-3 py-1 rounded-full text-xs font-bold bg-slate-100 text-slate-700">Free Tier</span>
                        <h3 class="text-2xl font-bold text-slate-900 mt-3 font-heading">Seeker Free</h3>
                        <p class="text-xs text-slate-500 mt-1">Everything needed to find your spouse</p>
                        <div class="my-6">
                            <span class="text-4xl font-extrabold text-slate-900 font-heading">$0</span>
                    ...
                    <a href="{{ route('register') }}" class="mt-8 block text-center w-full py-3 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-800 text-sm font-bold transition">
                        Get Started Free
                    </a>
                </div>

                <!-- Premium Tier -->
                <div class="bg-white rounded-2xl p-8 border-2 border-emerald-600 shadow-xl relative flex flex-col justify-between transform md:-translate-y-2">
                    ...
                    <div>
                        <span class="px-3 py-1 rounded-full text-xs font-bold bg-emerald-100 text-emerald-800">Premium</span>
                        <h3 class="text-2xl font-bold text-slate-900 mt-3 font-heading">Seeker Premium</h3>
                        <p class="text-xs text-slate-500 mt-1">Full access with unlimited discovery</p>
                        <div class="my-6">
                            <span class="text-4xl font-extrabold text-slate-900 font-heading">$19.99</span>
                            <span class="text-xs text-slate-500">/ month</span>
                        </div>
                        <ul class="space-y-3 text-sm text-slate-700 border-t border-slate-100 pt-6">
                            <li class="flex items-center gap-2 font-semibold text-emerald-700">✓ Unlimited daily profile views</li>
                            <li class="flex items-center gap-2 font-semibold text-emerald-700">✓ Unlimited interest requests</li>
                ...
                <div class="bg-white rounded-2xl p-8 border border-slate-200 shadow-xs flex flex-col justify-between">
                    <div>
                        <span class="px-3 py-1 rounded-full text-xs font-bold bg-amber-100 text-amber-800">VIP Premium+</span>
                        <h3 class="text-2xl font-bold text-slate-900 mt-3 font-heading">Seeker VIP</h3>
                        <p class="text-xs text-slate-500 mt-1">Profile boost & dedicated support</p>
                        <div class="my-6">
                            <span class="text-4xl font-extrabold text-slate-900 font-heading">$39.99</span>
                            <span class="text-xs text-slate-500">/ month</span>
                        </div>
                        <ul class="space-y-3 text-sm text-slate-600 border-t border-slate-100 pt-6">
                            <li class="flex items-center gap-2 font-semibold text-amber-700">✓ Top profile boost in search</li>
                    ...
                    <a href="{{ route('subscription.checkout', 'premium_plus') }}" class="mt-8 block text-center w-full py-3 rounded-xl bg-slate-900 hover:bg-black text-white text-sm font-bold transition">
                        Choose VIP
                    </a>
                </div>
            </div>
